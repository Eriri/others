...
identification and decision analysis. In this paper, we propose a new belief rule 
structure and its traning method, aiming to solve zero activation during the inference 
process and improve inference accuray. We first omitted the belief distribution conversion 
for the input data, and used the Gaussian function to calculate the similarity of each 
attribute. Then we 
\end{abstract}
