...
\begin{abstract}
    ...
    Experiments on several public classification datasets are conducted to validate the new BRB system trained by stochastic gradient descent with momentum (SGDM-BRB) compared with some recent works.
